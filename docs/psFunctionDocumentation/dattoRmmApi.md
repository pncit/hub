...
- [Get-DeviceData](#Get-DeviceData)
 ...
 - [Get-DeviceOpenAlerts](#Get-DeviceOpenAlerts)
 ...
 - [Set-DeviceOpenAlertToResolved](#Set-DeviceOpenAlertToResolved)
...
```
Get-DeviceOpenAlerts [[-apiAccessToken] <String>] [[-apiUrl] <String>] [-deviceId] <String>
 [<CommonParameters>]
```
...
```
Get-Devices [[-apiAccessToken] <String>] [[-apiUrl] <String>] [<CommonParameters>]
```
...
```
Set-DeviceOpenAlertToResolved [[-apiAccessToken] <String>] [[-apiUrl] <String>] [-alertUid] <String>
 [<CommonParameters>]
```
